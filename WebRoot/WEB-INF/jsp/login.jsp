...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<font id="mmcw" color="red" style="font-size: 15px; background-color: white">${mmcw}</font>
	<form class="login-form" action="login_login.action" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" value="ccui" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
