...
<html>
  ...
  <body>
    <div style="width:80%;height:auto;margin:0px auto;">
	    <form action="update.action" method="post" id="myForm" >
	    	<table class="table table-hover" style="width:80%;height:auto;margin:0px auto;">
	    		<tr>
	    			<td>日记标题：<input type="text" id="title" value="${dd.title}" name="title" /><s:token></s:token></td>
	    		</tr>
	    		<tr>
	    			<td>
	    				日记内容：<br /><textarea id="content" name="content" rows="30" cols="120">${dd.content }</textarea><s:token></s:token>
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>
